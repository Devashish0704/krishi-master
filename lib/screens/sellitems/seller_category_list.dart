  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Choose Categories',style: TextStyle(color: Colors.black,),),
                  ...
                  return Padding(
                    ...
                    child: ListTile(
                     ...
                     leading: Image.network(doc['image'],width: 40,),
                      title: Text(doc['catName'],style: const TextStyle(fontSize: 15),),
                      trailing:doc['subCat']==null?null: const Icon(Icons.arrow_forward_ios,size: 12,),
                    ),
                  );
                },
              ),
