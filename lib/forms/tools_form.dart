...
class SellertoolsForm extends StatefulWidget {
  ...
  const SellertoolsForm({Key? key}) : super(key: key);
...
class _SellertoolsFormState extends State<SellertoolsForm> {
  ...
  final _etypecontroller = TextEditingController();
  ...
  final List<String> _TypeList = ['Automatic', 'Manual'];
  @override
                  ...
                  InkWell(
                    ...
                    child: Neumorphic(
                      ...
                      child: SizedBox(
                        height: 40,
                        child: Center(
                          child: Text(_catProvider.urlList.isNotEmpty
                              ? 'Upload more image'
                              : 'Upload more image'),
                        ),
                      ),
